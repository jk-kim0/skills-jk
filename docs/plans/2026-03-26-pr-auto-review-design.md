...
```bash
gh search prs --review-requested=@me --state open --limit 100 --json number,repository,createdAt,url,isDraft
gh pr list --repo <owner/repo> --state open --limit 100 --json number,createdAt,headRefOid,isDraft,url
```
