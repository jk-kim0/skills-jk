---
name: corp-web-japan
description: Use when working in corp-web-japan, querypie.ai, or querypie.com/ja migration/parity tasks; contains migrated repo-specific memory and user preferences.
version: 1.0.0
author: Hermes Agent
license: MIT
metadata:
...
- The current task is in or about `corp-web-japan`.
...
- [ ] Skill loaded because the task matches `corp-web-japan`.
