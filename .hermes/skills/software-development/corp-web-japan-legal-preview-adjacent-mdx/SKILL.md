...
- A privacy-policy implementation with `src/app/t/privacy-policy/page.tsx`, `src/app/t/privacy-policy/[slug]/page.tsx`, route-local helper modules under `src/app/t/privacy-policy/`, and versioned files under `src/content/privacy-policy/*.mdx` is an appropriate structure for a versioned legal document collection.
