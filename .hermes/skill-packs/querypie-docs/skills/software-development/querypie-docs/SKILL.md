---
name: querypie-docs
description: Use when working in querypie-docs, especially confluence-mdx forward conversion and reverse-sync workflows; contains migrated repo-specific memory and user preferences.
version: 1.0.0
author: Hermes Agent
license: MIT
metadata:
...
- The current task is in or about `querypie-docs`.
...
- [ ] Skill loaded because the task matches `querypie-docs`.
