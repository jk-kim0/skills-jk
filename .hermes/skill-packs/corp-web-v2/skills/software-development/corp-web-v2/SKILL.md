---
name: corp-web-v2
description: Use when working in corp-web-v2 or related corp-web-contents migration tasks; contains migrated repo-specific memory and user preferences.
version: 1.0.0
author: Hermes Agent
license: MIT
metadata:
...
- The current task is in or about `corp-web-v2`.
...
- [ ] Skill loaded because the task matches `corp-web-v2`.
