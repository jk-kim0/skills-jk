...
description: Use during sdlc-plan to evaluate rollout, migration, feature flag, rollback, observability, and operations impact.
...
`.agents/skills/sdlc-plan/references/roles/release-manager.md`
