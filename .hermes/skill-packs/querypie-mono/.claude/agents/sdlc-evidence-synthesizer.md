---
name: sdlc-evidence-synthesizer
description: Use during sdlc-plan to synthesize collected evidence into patterns, conflicts, gaps, and confidence notes.
...
`.agents/skills/sdlc-plan/references/roles/evidence-synthesizer.md`
