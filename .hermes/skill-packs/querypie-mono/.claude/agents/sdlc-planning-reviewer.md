---
name: sdlc-planning-reviewer
description: Use during sdlc-plan to review final planning artifacts for clarity, evidence, decisions, and handoff quality.
...
`.agents/skills/sdlc-plan/references/roles/planning-reviewer.md`
