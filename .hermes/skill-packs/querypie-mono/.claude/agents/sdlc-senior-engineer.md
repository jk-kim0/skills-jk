...
description: Use during sdlc-plan to assess current code state, affected components, feasibility, complexity, and engineering risk.
...
`.agents/skills/sdlc-plan/references/roles/senior-engineer.md`
