...
description: Use during sdlc-plan when user flow, screen behavior, usability, interaction, or copy may change.
...
`.agents/skills/sdlc-plan/references/roles/ux-designer.md`
