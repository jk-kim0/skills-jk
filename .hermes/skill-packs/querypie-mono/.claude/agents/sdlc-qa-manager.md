---
name: sdlc-qa-manager
description: Use during sdlc-plan to identify acceptance coverage, regression risk, manual verification, and automation candidates.
...
`.agents/skills/sdlc-plan/references/roles/qa-manager.md`
