---
name: sdlc-technical-manager
description: Use during sdlc-plan to evaluate ownership, cross-component coordination, sequencing, and architectural tradeoffs.
...
`.agents/skills/sdlc-plan/references/roles/technical-manager.md`
