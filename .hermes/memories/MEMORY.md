...
§
In the skills-jk repo, portable Hermes state should live in tracked `.hermes/config.yaml`, tracked markdown memories under `.hermes/memories/`, and the repo `skills/` tree; runtime artifacts like `.hermes/checkpoints/`, `.hermes/sessions/`, logs, `state.db*`, caches, and generated `.hermes/.env` should stay untracked/ignored.
§
