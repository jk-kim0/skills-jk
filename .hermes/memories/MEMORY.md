...
§
Mac Studio LLM1: `qp-test@10.11.1.11` (`Mac-Studio-LLM1.local`). QueryPie runners live at `/Users/qp-test/Workspace/github-runners-for-querypie-org`: 6 Linux ARM64 Compose runners, group `mac-studio-llm1-linux-arm64`, purpose ci/build.
§
...
§
In corp-web-app routing, unprefixed English public URLs should be middleware rewrites to /en/...; non-English defaults redirect to /ko or /ja. QueryPie website messaging should position QueryPie as an AI Solution/AI Platform company, not primarily a security company; ACP/security assets should be framed as AI Connect Platform/security-for-AI while still serving humans.