...
§
In corp-web-app, English canonical public routes use `/en` prefix (e.g. `/en/blog`). In corp-web-japan/corp-web-app, promoted `/t/*` routes are removed; no compatibility paths or redirects unless requested.
§
